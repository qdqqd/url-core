...
async function fetchBingImages() {
    ...
    const endpoint = isWideScreen 
        ? 'https://pixiv-api.wrnm.dpdns.org/pc_pixiv.json' 
        : 'https://pixiv-api.wrnm.dpdns.org/pe_pixiv.json';
