async function fetchBingImages() {
    ...
    const endpoint = isWideScreen ? 'http://api.allorigins.win/raw?url=https://api.lolicon.app/setu/v2?size=regular&num=20&aspectRatio=gt1' : 'http://api.allorigins.win/raw?url=https://api.lolicon.app/setu/v2?size=regular&num=20&aspectRatio=lt1'; 
