...
function initFluidBackground() {
	// 创建容器和canvas元素
	let container = document.getElementById('fluid-background-wrap');
	if (!container) {
		container = document.createElement('div');
		container.id = 'fluid-background-wrap';
	...
	let canvas = document.getElementById("fluid-background");
	if (!canvas) {
	...
	var lastUpdateTime = Date.now(),
		...
		initBackground = function e() {
			e.loaded || (e.loaded = !0, updateKeywords(), initFramebuffers(), multipleSplats(parseInt(20 * Math.random()) + 5), update(!0))
		};
